...
$config['adminpanel']['view_default'] = 'basic';
...
$config['textoncollage']['limit'] = 0;
$config['textoncollage']['placeholder'] = true;
$config['textoncollage']['enabled'] = true;
$config['textoncollage']['flip'] = true;
$config['textoncollage']['polaroid_rotation'] = '0';
$config['textoncollage']['polaroid_effect'] = true;
